function varargout = GeneticAlgorithm3(varargin)
% GENETICALGORITHM3 MATLAB code for GeneticAlgorithm3.fig
%      GENETICALGORITHM3, by itself, creates a new GENETICALGORITHM3 or raises the existing
%      singleton*.
%
%      H = GENETICALGORITHM3 returns the handle to a new GENETICALGORITHM3 or the handle to
%      the existing singleton*.
%
%      GENETICALGORITHM3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GENETICALGORITHM3.M with the given input arguments.
%
%      GENETICALGORITHM3('Property','Value',...) creates a new GENETICALGORITHM3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GeneticAlgorithm3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GeneticAlgorithm3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GeneticAlgorithm3

% Last Modified by GUIDE v2.5 24-Nov-2015 17:44:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GeneticAlgorithm3_OpeningFcn, ...
                   'gui_OutputFcn',  @GeneticAlgorithm3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GeneticAlgorithm3 is made visible.
function GeneticAlgorithm3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GeneticAlgorithm3 (see VARARGIN)

% Choose default command line output for GeneticAlgorithm3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GeneticAlgorithm3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GeneticAlgorithm3_OutputFcn(~, eventdata, handles) 
