function varargout = GeneticAlgorithm2(varargin)
% GENETICALGORITHM2 MATLAB code for GeneticAlgorithm2.fig
%      GENETICALGORITHM2, by itself, creates a new GENETICALGORITHM2 or raises the existing
%      singleton*.
%
%      H = GENETICALGORITHM2 returns the handle to a new GENETICALGORITHM2 or the handle to
%      the existing singleton*.
%
%      GENETICALGORITHM2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GENETICALGORITHM2.M with the given input arguments.
%
%      GENETICALGORITHM2('Property','Value',...) creates a new GENETICALGORITHM2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GeneticAlgorithm2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GeneticAlgorithm2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GeneticAlgorithm2

% Last Modified by GUIDE v2.5 24-Nov-2015 21:35:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GeneticAlgorithm2_OpeningFcn, ...
                   'gui_OutputFcn',  @GeneticAlgorithm2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GeneticAlgorithm2 is made visible.
function GeneticAlgorithm2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GeneticAlgorithm2 (see VARARGIN)

% Choose default command line output for GeneticAlgorithm2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GeneticAlgorithm2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GeneticAlgorithm2_OutputFcn(~, eventdata, handles) 
...
dlmwrite('Function2GAResults.csv', [XAxisData; YAxisData],'-append', 'delimiter', '\t', 'newline', 'pc')  
